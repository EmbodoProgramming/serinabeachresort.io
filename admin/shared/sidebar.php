    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left image">
          ...
          <img src="../dist/img/profileAdmin.jpg" class="img-circle" alt="User Image">
      ...
      <?php 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="?reserved2"><i class="fa fa-tasks"></i> Approved</a></li>

            <li><a href="?canceled"><i class="fa fa-tasks"></i> Decline</a></li>
        ...
        <li><a href="#" data-toggle="modal" data-target="#modal-logout"><i class="fa fa-power-off"></i> <span>Sign Out</span></a></li>
